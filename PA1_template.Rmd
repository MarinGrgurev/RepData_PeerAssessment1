...
```{r HistogramMeanTotalStepsDay, echo=TRUE, results='hide'}
...
```{r HistogramFigureSave, echo=TRUE, results='hide'}
...
```{r TimeseriesFigureSave, echo=TRUE, results='hide'}
...
```{r HistogramMeanTotalStepsDayImputed, echo=TRUE, results='hide'}
...
```{r HistogramFigureSaveImputed, echo=TRUE, results='hide'}
dev.copy(png,"./figures/histogram.png", width=480, height=480, bg="transparent")
dev.off()
```

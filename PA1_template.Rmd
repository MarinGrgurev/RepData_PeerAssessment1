...
The mean total number of steps taken per day is `r format(mean(data[,list(total=sum(steps)), by="date"][[2]]))`.  
The median total number of steps taken per day is `r format(median(data[,list(total=sum(steps)), by="date"][[2]]))`.
